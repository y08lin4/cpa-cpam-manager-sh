...
[2026-07-12 08:01:00] [efgh5678] [warn ] [gin_logger.go:99] 401 |           2ms |         1.1.1.1 | GET     "/v1/models"
...
grep -Fq $'auth_failure\t1\t1.1.1.1\tpublic' <<<"$REPORT"
grep -Fq $'auth_failure\t1\t10.0.0.8\tinternal' <<<"$REPORT"
